...
# Ravencoin
DEFINES += COIN_P2PKH_VERSION=60 COIN_P2SH_VERSION=122 COIN_FAMILY=1 COIN_COINID=\"Ravencoin\" COIN_COINID_HEADER=\"RAVENCOIN\" COIN_COLOR_HDR=0xEE5441 COIN_COLOR_DB=0xFFFFFF COIN_COINID_NAME=\"Ravencoin\" COIN_COINID_SHORT=\"RVN\" COIN_KIND=COIN_KIND_RVN COIN_FLAGS=FLAG_RAVENCOIN_SUPPORT
APPNAME ="Ravencoin"
APP_LOAD_PARAMS += --path $(APP_PATH)
else
